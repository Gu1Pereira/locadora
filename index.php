...
<body class="bg-warning">
    <div class="container">
        <div class="row mt-5">  <!--mt-5-->
            <div class="col-lg-4 col-md-6 col-12 text-center bg-light shadow"> <!--bg-light-->
            ...
            <form action="salvar1.php" method="post">
                ...
                <div class="mb-3">
                    <button class="btn btn-warning w-100 text-light fw-bolder rounded-0">FAZER MINHA RESERVA</button> <!-- mudar o button para warning, adicionar fw-bolder, text-light(cor do texto), rounded-0(borda) e o texto para FAZER MINHA RESERVA-->
